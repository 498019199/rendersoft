...
template<typename U>
inline Quaternion_T<U> operator*(const Quaternion_T<U>& lhs, const U rhs) noexcept
{
	return Quaternion_T<U>(lhs).operator*=(rhs);
}
template<typename U>
inline Quaternion_T<U> operator/(const Quaternion_T<U>& lhs, const U rhs) noexcept
{
...
template<typename U>
inline Quaternion_T<U> operator+(const Quaternion_T<U>& lhs, const Quaternion_T<U>& rhs) noexcept
{
	return Quaternion_T<U>(lhs).operator+=(rhs);
}
template<typename U>
