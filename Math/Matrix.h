...
template<typename U>
inline Matrix4_T<U> operator*(const Matrix4_T<U>& lhs, const U rhs) noexcept
{
	return Matrix4_T<U>(lhs).operator*=(rhs);
}
template<typename U>
inline Matrix4_T<U> operator/(const Matrix4_T<U>& lhs, const U rhs) noexcept
{
...
template<typename U>
inline Matrix4_T<U> operator+(const Matrix4_T<U>& lhs, const Matrix4_T<U>& rhs) noexcept
{
	return Matrix4_T<U>(lhs).operator+=(rhs);
}
template<typename U>
