...
#ifndef TINYRENDER_VECTOR_H
#define TINYRENDER_VECTOR_H
...
inline Vector_T<U, SIZE> operator*(const Vector_T<U, SIZE>& lhs, const U rhs) noexcept
{
	return Vector_T<U, SIZE>(lhs).operator*=(rhs);
}
template<typename U, int SIZE>
inline Vector_T<U, SIZE> operator/(const Vector_T<U, SIZE>& lhs, const U rhs) noexcept
{
...
template<typename U, int SIZE>
inline Vector_T<U, SIZE> operator+(const Vector_T<U, SIZE>& lhs, const Vector_T<U, SIZE>& rhs) noexcept
{
	return Vector_T<U, SIZE>(lhs).operator+=(rhs);
}
template<typename U, int SIZE>
...
template<typename U, int SIZE>
bool operator==(const Vector_T<U, SIZE>& lhs, const Vector_T<U, SIZE>& rhs) noexcept
{
